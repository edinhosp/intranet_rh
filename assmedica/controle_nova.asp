...
function data1() {	form.ivigencia.value=form.inclusao.value;	}
--></script>
</head>
<body>
<%
...
if request.form("bt_salvar")<>"" then
	...
	if request.form("up")="" then up="0001" else up=request.form("up")
	sql = "INSERT INTO assmed_mudanca (" 
	sql = sql & "chapa, empresa, plano, codigo, up, "
...
%>
<form method="POST" action="controle_nova.asp" name="form" >
<table border="0" cellpadding="3" cellspacing="0" width="500">
<tr><td class=grupo>Inclusão de Assistência Médica</td></tr>
</table>

<table border="0" cellpadding="3" cellspacing="0" width="500">
<tr><td class=titulo>Funcionário beneficiado</td></tr>
...
rsc.movefirst
do while not rsc.eof
if request.form("empresa")=rsc("codigo") then tempt="selected" else tempt=""
%>
...
%>
	...
	<td class=titulo><input type="text" name="up" size="4" value="<%=request.form("up")%>"></td>
</tr>
</table>
...
<tr>
	<td class=titulo><input type="text" name="codigo"  size="25" value="<%=request.form("codigo")%>"></td>
