...
<title>Inclusão de Categoria de Uniforme</title>
...
if request.form<>"" then
	if request.form("bt_salvar")<>"" then
		sql = "INSERT INTO uniforme_categoria (descricao, usuarioc, datac ) " & _
...
if request.form="" then
%>
<form method="POST" action="categ_nova.asp">
<input type="hidden" name="id_cat" size="4" value="0">
<table border="0" cellpadding="3" cellspacing="0" width="500">
	<tr><td class=grupo>Categoria de Uniformes</td></tr>
</table>
...
<tr>
	...
	<td class=fundo><input type="text" name="descricao" size="70" value=""></td>
</tr>
</table>
