...
<tr>
	...
	<td class=campo><select name="nome" class=a onchange="nome1()">
		...
		<option value="m01">Aniversários de JANEIRO</option>
...
<table border="0" cellpadding="5" cellspacing="0" width="650">
	<tr>
		...
		<td align="right"><p style="font-size:18pt"><b>Abono de Aniversário</b><td>
	</tr>
</table>
<br><br>
...
aniv=dateserial(year(now),month(dtnasc),day(dtnasc))
...
De acordo com a Instrução nº 03/06 da Pró-Reitoria Administrativa, e tendo em vista que meu aniversário
será em <%=formatdatetime(aniv,2)%> (<%=diasem2%>), faço a opção por:
<br>
<br>[&nbsp;&nbsp;&nbsp;] gratificação no valor correspondente a um dia de salário;
<br>
<br>[&nbsp;&nbsp;&nbsp;] um dia de descanso na data de <u>&nbsp;<%=diadescanso%>&nbsp;</u>.
<br>
<br>
<br>
E de acordo com o art. 3º da Intrução nº 2/2002 de 26/02/02, estou ciente de que perderei o abono caso tenha faltado nos 12 (doze)
