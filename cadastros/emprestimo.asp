...
<title>Controle de Empréstimos Consignados</title>
...
<p class="titulo" style="margin-top: 0; margin-bottom: 0">Controle de Empréstimos Consignados</p>
...
<B>PENDÊNCIAS
<%
sqlp="select e.chapa, f.nome, e.valor, e.data, Situação=case when dt_assfieo>0 and (dt_banco='' or dt_banco is null) then 'Enviado Pro-Reitoria / Não enviado Banco' " & _
"else case when (dt_assfieo='' or dt_assfieo is null) and (dt_banco='' or dt_banco is null) then 'Não enviado Pro-Reitoria' else 'Verificar caso' end end " & _
