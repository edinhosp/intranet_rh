...
if request.form<>"" then
	...
	"where (CODSITUACAO<>'D' or (codsituacao='D' and datademissao>'20160101')) and CODTIPO='N' and CODSINDICATO<>'03' " & _
	"and f.chapa='" & chapa & "' "
...
%>
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="340">
...
<tr>
	...
	<td><img src="caixa3.png" border="0"></td>
</tr>


<form method="POST" action="index.asp">
<input type="hidden" name="ncheck" value="<%=ncheck1%>">
<table border="0" cellpadding="2" cellspacing="0" style="border-collapse: collapse" width="340">
<tr>
...
if visualiza=1 then
response.write "<br>"
sqlc="select nome='TITULAR (" & nome1 & ")', plano, 'Carteira'=codigo, up from assmed_mudanca where chapa='" & chapa & "' and empresa='C' and getdate() between ivigencia and fvigencia " & _
"union all select NOME=intranet_rh.dbo.primeironome(d.NOME), plano, 'Carteira'=m.codigo, up " & _
...
"where m.chapa='" & chapa & "' and empresa='C' and getdate() between ivigencia and fvigencia "
rs.Open sqlc, ,adOpenStatic, adLockReadOnly
%>
<table border="1" cellpadding="2" cellspacing="2" style="border-collapse: collapse" width="340">
<tr><td class="titulop">Nome</td><td class="titulop">Nº Cartão</td><td class="titulop">Plano</td></tr>
<%
do while not rs.eof
%>
<tr><td class="campop"><%=rs("nome")%></td><td class="campop"><%=rs("carteira")%></td><td class="campop"><%=rs("plano")%></td></tr>
<%
rs.movenext
loop
rs.close
...
<br>
Central de Atendimento Caixa Seguros Saúde: 3003 0085<br>
Endereço da Rede: <a href="https://www.caixasegurossaude.com.br/site/" target="_blank">Clique aqui</a>
<br><br>
<a href="https://www.caixasegurossaude.com.br/site/" target="_blank">
