...
<tr>
	<td class="campop" align="left" valign="center"><b>PONTO DO PESSOAL DOCENTE DO CURSO DE <input class=form_ponto type="text" name="curso" size="35" value="digite o curso"></b></td>
...
<tr>
	...
	<input class=form_ponto type="text" name="diasem" size="11" value="<%=weekdayname(weekday(now))%>" >
...
<tr>
	...
	<td class=titulo align="center" colspan=4>Classes</td>
	<td class=fundo align="center">Faltas</td>
	<td class=fundo align="center">Observações</td>
</tr>	
<tr>
	<td class="campor" align="center" height=35>&nbsp;</td>
	<td class="campor"><b><input style="font-size:8pt;text-align:left" class=form_input type="text" name="professor" size="40" value="-> Digite aqui o Nome do professor">
				</b><br><input style="font-size:7pt;text-align:left" class=form_input type="text" name="materia" size="40" value="-> Digite aqui o nome da Disciplina"></td>
...
<tr>
	...
	<td class="campop" width=150>&nbsp;</td>
<%for a=1 to 4 %>	
	<td class=campo align="center"><input style="font-size:8pt;text-align:left" class=form_input type="text" name="classe" size="1" value=""></td>
<%next%>
	<td class=campo>&nbsp;</td>
	<td class=campo>&nbsp;</td>
</tr>
