...
if request.form<>"" then
	if request.form("bt_salvar")<>"" then
		...
		tudook=1
			sqla = "INSERT INTO grades_2 (perlet, perlet2, perletsg, coddoc, curso, turno, serie, turma, diasem, enfase, "
...
<%
sqla="SELECT p.coddoc, g.curso as nome FROM grades_per p, g2cursoeve g where g.coddoc=p.coddoc and p.tper='G' and p.lanc=1 " & _
...
<%
sqlc="select count(chapa1) as taulas from g2ch where chapa1='" & chapa1 & "' and perlet2 like '" & left(perlet2,4) & "%" & right(perlet2,1) & "' and juntar=0 "
...
%>
	...
	<td class=fundo align="left">
<%
sqlc="select count(chapa1) as taulas from g2ch where chapa1='" & chapa2 & "' and perlet2 like '" & left(perlet2,4) & "%" & right(perlet2,1) & "' and deletada=0 "
rsd.Open sqlc, ,adOpenStatic, adLockReadOnly
taulas2=rsd("taulas")
rsd.close
%>	
