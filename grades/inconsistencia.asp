...
inicio=now()
fast=0 : fast2=0 : fast3=0 : fast4=0 : fast5=0 : fast6=0
periodo="2016%2"
periodo2="('2016/2','2016/0')"
fimper=dateserial(2016,7,31)
inicioper=dateserial(2016,8,1)
...
if status="I"  then abai=aba1  else abai=aba0
...
<tr>
	<td class="campo"><b>Checagem de Inconsistências na Grade Horária</b></td>
	<td class=campo width="5">&nbsp;</td>

	<td class=campor width="70" align="center" style="<%=abaa%>">
	<a class="r" href="inconsistencia.asp?status=A">	Ativos</a></td>
	<td class=campo width="5">&nbsp;</td>

	<td class=campor width="70" align="center" style="<%=abaa2%>">
	<a class="r" href="inconsistencia.asp?status=A2">	Acima/Abaixo<br>Limite</a></td>
	<td class=campo width="5">&nbsp;</td>

	<td class=campor width="70" align="center" style="<%=abad%>">
	<a class="r" href="inconsistencia.asp?status=D">	Afastados<br>Demitidos</a></td>
	<td class=campo width="5">&nbsp;</td>

	<td class=campor width="70" align="center" style="<%=abac%>">
	<a class="r" href="inconsistencia.asp?status=C">	Sem aula /<br>Contratação</a></td>
	<td class=campo width="5">&nbsp;</td>

	<td class=campor width="70" align="center" style="<%=abaj%>">
	<a class="r" href="inconsistencia.asp?status=J">	Problemas Junções</a></td>
	<td class=campo width="5">&nbsp;</td>
	
	<td class=campor width="70" align="center" style="<%=abaj2%>">
	<a class="r" href="inconsistencia.asp?status=J2">	Junções </a></td>
	<td class=campo width="5">&nbsp;</td>
	
	<td class=campor width="70" align="center" style="<%=abai%>">
	<a class="r" href="inconsistencia.asp?status=I">	Intervalos </a></td>
	<td class=campo width="5">&nbsp;</td>
</tr>
</table>
...
sql3="select g.id_grdaula, coddoc, codtur, chapa1, f.nome, g.codmat, materia, diasem, descricao, codhor, id_grdturma, codsituacao, usuarioc, usuarioa  " & _
"from g2ch g left join dc_professor f on g.chapa1=f.chapa " & _
"left join corporerm.dbo.ugrade m on m.CODCUR=g.codcur and m.CODPER=g.codper and m.GRADE=g.grade and m.CODMAT collate database_default=g.codmat " & _
"where deletada=0 and g.perlet in " & periodo2 & " and '" & dtaccess(datacheck) & "' between inicio and termino and chapa1<>'99998' " & _
"and m.GRUPOMATERIA='4' order by coddoc, codtur "
rs.Open sql3, ,adOpenStatic, adLockReadOnly
total=rs.recordcount
%>
<table border="1" bordercolor="#CCCCCC" cellpadding="0" width="700" cellspacing="0" style="border-collapse: collapse">
...
"group by chapa1 " & _
") z left join (select chapa, 'limite'=SUM(limite) from g2limite group by chapa) l on z.chapa=l.chapa) left join grades_aux_prof f on f.chapa=z.chapa " & _
...
"left join (select chapa, 'limite'=SUM(limite) from g2limite group by chapa) l on l.chapa=f.chapa " & _
...
"	from (g2ch g left join dc_professor f on g.chapa1=f.chapa) " & _
"	where deletada=0 and g.perlet in ('2016/1','2016/0') and f.codsituacao in ('D') and '" & dtaccess(fimper) & "' between inicio and termino " & _
...
"left join (select chapa1, aula_atual=sum(ta) from g2ch g where deletada=0 and g.perlet in ('2016/0','2016/2') and '08/01/2016' between inicio and termino and chapa1<'10000' group by chapa1) a on a.chapa1=f.chapa " & _
") left join (select chapa1, aula_ant=sum(ta) from g2ch g where deletada=0 and g.perlet in ('2016/0','2016/1') and '07/31/2016' between inicio and termino and chapa1<'10000' group by chapa1) b on b.chapa1=f.chapa " & _
...
"and f.chapa not in ('00057','00056','00066','00063','01514','01164','01165','02768','02820','02823','00077','02900') and codsituacao in ('A','F','E','Z') "
rs.Open sql3, ,adOpenStatic, adLockReadOnly
total=rs.recordcount
%>
<table border="1" bordercolor="#CCCCCC" cellpadding="0" width="700" cellspacing="0" style="border-collapse: collapse">
...
"from g2ch g, g2periodoaula p where g.perlet=p.perlet and deletada=0 and g.perlet in " & periodo2 & " " & _
"and (g.inicio<p.inicio or g.termino>p.termino) and '" & dtaccess(datacheck) & "' between g.inicio and g.termino "
sql3="SELECT z.chapa1, f.nome, z.codtur, z.materia, z.diasem, z.descricao, z.horfim, z.turma_dia_seguinte from( " & _
"SELECT chapa1, coddoc, codtur, turno, codmat, materia, diasem, pos, horini, horfim, descricao, " & _
"turma_dia_seguinte=(select 'Terça '+horini+' '+codtur+' '+materia collate database_default from g2ch where chapa1=g.chapa1 and perlet in " & periodo2 & " and diasem=3 and horini='07:30' and chapa1 not like '99%' and deletada=0 and juntar=0) " & _
"FROM G2CH g WHERE perlet IN " & periodo2 & " and diasem=2 and horfim='22:30' and chapa1 not like '99%' and deletada=0 and juntar=0 " & _
"union " & _
"SELECT chapa1, coddoc, codtur, turno, codmat, materia, diasem, pos, horini, horfim, descricao, " & _
"turma_dia_seguinte=(select 'Quarta '+horini+' '+codtur+' '+materia collate database_default from g2ch where chapa1=g.chapa1 and perlet in " & periodo2 & " and diasem=4 and horini='07:30' and chapa1 not like '99%' and deletada=0 and juntar=0) " & _
"FROM G2CH g WHERE perlet IN " & periodo2 & " and diasem=3 and horfim='22:30' and chapa1 not like '99%' and deletada=0 and juntar=0 " & _
"union " & _
"SELECT chapa1, coddoc, codtur, turno, codmat, materia, diasem, pos, horini, horfim, descricao, " & _
"turma_dia_seguinte=(select 'Quinta '+horini+' '+codtur+' '+materia collate database_default from g2ch where chapa1=g.chapa1 and perlet in " & periodo2 & " and diasem=5 and horini='07:30' and chapa1 not like '99%' and deletada=0 and juntar=0) " & _
"FROM G2CH g WHERE perlet IN " & periodo2 & " and diasem=4 and horfim='22:30' and chapa1 not like '99%' and deletada=0 and juntar=0 " & _
"union " & _
"SELECT chapa1, coddoc, codtur, turno, codmat, materia, diasem, pos, horini, horfim, descricao, " & _
"turma_dia_seguinte=(select 'Sexta '+horini+' '+codtur+' '+materia collate database_default from g2ch where chapa1=g.chapa1 and perlet in " & periodo2 & " and diasem=6 and horini='07:30' and chapa1 not like '99%' and deletada=0 and juntar=0) " & _
"FROM G2CH g WHERE perlet IN " & periodo2 & " and diasem=5 and horfim='22:30' and chapa1 not like '99%' and deletada=0 and juntar=0 " & _
"union " & _
"SELECT chapa1, coddoc, codtur, turno, codmat, materia, diasem, pos, horini, horfim, descricao, " & _
"turma_dia_seguinte=(select max('Sábado '+horini+' '+codtur+' '+materia collate database_default) from g2ch where chapa1=g.chapa1 and perlet in " & periodo2 & " and diasem=7 and horini='07:30' and chapa1 not like '99%' and deletada=0 and juntar=0) " & _
"FROM G2CH g WHERE perlet IN " & periodo2 & " and diasem=6 and horfim='22:30' and chapa1 not like '99%' and deletada=0 and juntar=0 " & _
") z inner join dc_professor f on f.chapa=z.chapa1 where turma_dia_seguinte is not null " & _
"order by codtur, f.nome, z.diasem "
rs.Open sql3, ,adOpenStatic, adLockReadOnly
total=rs.recordcount
%>
<table border="1" bordercolor="#CCCCCC" cellpadding="0" width="700" cellspacing="0" style="border-collapse: collapse">
<tr><td class="grupo" colspan=8 height=20 valign=middle align="center">Professores ultrapassando o limite de 11 horas (<%=total%>)</td></tr>
<%
if rs.recordcount>0 then
%>
<tr><td class="titulor" align="center">Turma</td>
	<td class="titulor" align="center">Disciplina/Professor</td>
	<td class="titulor" align="center">Dia</td>
	<td class="titulor" align="center">Aula</td>
	<td class="titulor" align="center">Turma Dia Seguinte</td>
	<td class="titulor" align="center">&nbsp;    </td>
</tr>
<%
rs.movefirst:do while not rs.eof
...
<tr>
	<td class="campor" nowrap><%=rs("codtur")%></td>
    <td class="campor" nowrap><%="<font color=""blue"">" & rs("nome") & "</font><br>" & rs("materia")%></td>
    <td class="campor"><%=weekdayname(rs("diasem"),1)%></td>
	<td class="campor"><%=rs("horfim")%></td>
	<td class="campor"><%=rs("turma_dia_seguinte")%></td>
	<td class="campor">
	</td>
</tr>
<%
...
"where deletada=0 and g.perlet in " & periodo2 & " and '" & dtaccess(datacheck) & "' between inicio and termino and chapa1<>'99998' " & _
"and m.GRUPOMATERIA='4' order by coddoc, codtur "
sql3="select case when diasem=7 then 1 else g.turno end, g.perlet, g.diasem, g.chapa1, f.NOME, g.inicio, g.termino " & _
", 'ini'=min(horini), 'fim'=max(horfim), 'tot'=count(pos), 'dur'=intranet_rh.dbo.hhmm(convert(smalldatetime,max(g.horfim))-convert(smalldatetime,min(g.horini))) " & _
", 'minpos'=MIN(pos), 'maxpos'=max(pos), 'check'=(max(pos)-MIN(pos)+1)-COUNT(pos), 't1'=min(codtur), 't2'=max(codtur) " & _
"from g2ch g inner join dc_professor f on f.chapa=g.chapa1 " & _
"where '" & dtaccess(datacheck) & "' between inicio and termino and deletada=0 and juntar=0 and chapa1<>'99998' " & _
"group by case when diasem=7 then 1 else g.turno end, g.perlet, g.diasem, g.chapa1, f.NOME, g.inicio, g.termino " & _
"having (max(pos)-MIN(pos)+1)-COUNT(pos)<>0 "
rs.Open sql3, ,adOpenStatic, adLockReadOnly
total=rs.recordcount
%>
<table border="1" bordercolor="#CCCCCC" cellpadding="0" width="700" cellspacing="0" style="border-collapse: collapse">
<tr><td class="grupo" colspan=8 height=20 valign=middle align="center">Janelas existentes na atribuição de Aulas (<%=total%>)</td></tr>
<%
if rs.recordcount>0 then
%>
<tr>
	<td class="titulor" align="center">Professor</td>
	<td class="titulor" align="center">Dia</td>
	<td class="titulor" align="center">Horário</td>
	<td class="titulor" align="center">Aulas</td>
	<td class="titulor" align="center">Janelas</td>
	<td class="titulor" align="center">Turmas Envolvidas</td>
	<td class="titulor" align="center">&nbsp;    </td>
</tr>
<%
rs.movefirst:do while not rs.eof
...
<tr>
    <td class="campor"><%=rs("nome")%></td>
    <td class="campor"><%=weekdayname(rs("diasem"),1)%></td>
	<td class="campor"><%=rs("ini") & " - " & rs("fim")%></td>
	<td class="campor"><%=rs("tot")%></td>
	<td class="campor"><%=rs("check")%></td>
    <td class="campor"><%=rs("t1") & " " & rs("t2") & " " & rs("perlet")%> </td>
	<td class="campor">
	</td>
</tr>
<%
