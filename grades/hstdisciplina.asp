...
sql1="select materia from corporerm.dbo.umaterias where codmat='" & codmat & "' "
rs.Open sql1, ,adOpenStatic, adLockReadOnly
if rs.recordcount>0 then materia=rs("materia") else materia=""
rs.close

sqli="select top 4 perlet from g2ch where right(perlet,1)<>'0' group by perlet order by perlet desc"
a=1
...
sqla="SELECT g.chapa1, d.NOME, d.TELEFONE1, g.materia, min(t.[" & t(4) & "]) as t4, min(t.[" & t(3) & "]) as t3, min(t.[" & t(2) & "]) as t2, min(t.[" & t(1) & "]) as t1 " & _
"FROM (g2ch g INNER JOIN totalizador_chor t ON g.chapa1 = t.chapa1) INNER JOIN dc_professor d ON g.chapa1 = d.CHAPA collate database_default " & _
...
<tr>
	...
	<td class=titulor colspan=4 align="center">Nº Aulas</td>
</tr>
<tr>
	<td class=titulor align="center"><%=t(4)%></td>
