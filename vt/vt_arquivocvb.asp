...
if session("a71")="N" or session("a71")="" then response.write "<script language='JavaScript' type='text/javascript'>window.top.location.href='" & Application("Site") & "';</script>"
%>
<html>
<head>
...
%>
<form method="POST" action="vt_arquivocvb.asp">
