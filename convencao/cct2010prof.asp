...
<title>Convenção Coletiva 2010/11 - Professores</title>
...
<tr><td class=titulo align="center">CONVENÇÃO COLETIVA DE TRABALHO PARA 2010
...
<tr><td class=campo style="text-align:justify">Esta Convenção Coletiva de Trabalho terá duração de um ano, com vigência de 1º de março de 2010 a 28 de fevereiro de 2011. 
<br><b>Parágrafo único</b> – As cláusulas poderão ser reexaminadas na próxima data base, em 1º de março de 2011, em virtude de problemas surgidos na sua aplicação ou do surgimento de normas legais a elas pertinentes, ou em decorrência de aprovação das propostas apresentadas pela Comissão de Aprimoramento das Relações de Trabalho prevista na cláusula 56 da presente Convenção. 

<tr><td class=titulo>3. Reajuste salarial 
<tr><td class=campo style="text-align:justify">I. Março de 2010: 
	<br>Em 1º de março de 2010, as MANTENEDORAS deverão reajustar os salários dos PROFESSORES em 4,0% (quatro por cento), aplicados sobre os salários devidos em 1º de março de 2009. 
<tr><td class=campo style="text-align:justify">II. Setembro de 2010: 
	<br>Em 1º de setembro de 2010, as MANTENEDORAS deverão reajustar os salários dos PROFESSORES em 5,0% (cinco por cento), aplicados sobre os salários devidos em 1º de março de 2009. 
<tr><td class=campo style="text-align:justify">III. Janeiro de 2011: 
	<br>Em 1º de janeiro de 2011, as MANTENEDORAS deverão reajustar os salários dos PROFESSORES em 5,5% (cinco e meio por cento), aplicados sobre os salários devidos em 1º de março de 2009. 
<br><b>Parágrafo primeiro</b> – A diferença salarial de março, abril e maio, correspondente à aplicação do reajuste definido no caput poderá ser paga até o dia 20 de agosto de 2010, juntamente com o Abono Salarial estabelecido na cláusula 4. 
<br><b>Parágrafo segundo</b> – Os salários de 1º de janeiro de 2011, reajustados de acordo com o que dispõe esta cláusula, constituirão a base de cálculo para a data-base de 1º de março de 2011. 

<tr><td class=titulo>4. Abono salarial 
<tr><td class=campo style="text-align:justify">Até o dia 20 de agosto de 2010, as MANTENEDORAS deverão conceder aos PROFESSORES, Abono Salarial no montante de 5,0% (cinco por cento) dos salários devidos em 1º de março de 2009. 

<tr><td class=titulo>5. Compensações salariais 
<tr><td class=campo style="text-align:justify">No ano de 2010 será permitida a compensação de eventuais antecipações salariais concedidas no período compreendido entre 1º de março de 2009 e 28 de fevereiro de 2010. 
...
<br><b>Parágrafo único</b> – Ao PROFESSOR admitido após 1º de março de 2010 será concedido o reajuste estabelecido na cláusula 3 desta norma coletiva. 
...
<br><b>Parágrafo segundo</b> – As MANTENEDORAS de Instituições de Ensino que possuam cursos tecnológicos nas condições definidas no parágrafo 1º desta cláusula deverão apresentar à Comissão Permanente de Negociação definida na cláusula 48, até o dia 15 de agosto de 2010, a documentação de autorização ou reconhecimento do curso com a determinação expressa de hora-aula com duração de sessenta minutos sob pena de, em não o fazendo, estar sujeita à majoração do valor do salário-aula de acordo com o que estabelece o parágrafo 4º desta cláusula. 
...
<br><b>Parágrafo terceiro</b> – O contrato de trabalho do PROFESSOR só poderá ser rescindido por mútuo acordo homologado pelo SINDICATO DA CATEGORIA PROFISSIONAL ou pedido de demissão.
...
<tr><td class=campo style="text-align:justify">As férias anuais dos PROFESSORES serão coletivas, com duração de trinta dias corridos e gozados em julho de 2010. Qualquer alteração deverá ser aprovada por órgão competente, conforme o estabelecido em Estatuto ou Regimento e deverá constar do calendário escolar. 
...
<tr><td class=campo style="text-align:justify">O recesso escolar anual é obrigatório e tem duração de trinta dias corridos, gozados preferencialmente no mês de janeiro de 2011. Durante o recesso escolar anual que não pode, de maneira alguma, coincidir com o período definido para as férias coletivas, o PROFESSOR não poderá ser convocado para nenhum trabalho. 
...
<blockquote style="margin-top:0;margin-bottom:0">a) Vinte dias corridos em janeiro de 2011 e os dois períodos com igual número de dias corridos, obrigatoriamente no período compreendido entre março de 2010 e fevereiro de 2011.
</blockquote>
...
<br><b>Parágrafo quarto</b> – Os calendários escolares que definirão os períodos de recesso escolar dos PROFESSORES serão obrigatoriamente divulgados aos PROFESSORES até o início de cada período letivo e enviados ao SINDICATO DA CATEGORIA PROFISSIONAL. 
...
<br><b>Parágrafo segundo</b> – A eleição dos Delegados Representantes será realizada pelo SINDICATO DA CATEGORIA PROFISSIONAL nas unidades de ensino da MANTENEDORA, por voto direto e secreto. É exigido quorum de 50% (cinqüenta por cento) mais um do corpo docente da unidade onde a eleição ocorrer. 
<br><b>Parágrafo terceiro</b> – O SINDICATO DA CATEGORIA PROFISSIONAL comunicará a eleição à MANTENEDORA, com a relação dos candidatos inscritos, com antecedência mínima de sete dias corridos, da data da eleição. Nenhum candidato poderá ser demitido a partir da data da comunicação até o término da apuração. 
<br><b>Parágrafo quarto</b> – É condição necessária que os candidatos sejam filiados ao SINDICATO DA CATEGORIA PROFISSIONAL e que tenham, à data da eleição, pelo menos um ano de serviço na MANTENEDORA. 

<tr><td class=titulo>42. Quadro de avisos 
<tr><td class=campo style="text-align:justify">A MANTENEDORA deverá colocar, nas salas de professores, quadro de aviso à disposição do SINDICATO DA CATEGORIA PROFISSIONAL para fixação de comunicados de interesse da categoria, sendo vedada a divulgação de matéria político-partidária ou ofensiva a quem quer que seja. 
...
<br><b>Parágrafo primeiro</b> - Na vigência desta Convenção, os abonos estão limitados a dois sábados e mais dois dias úteis. As duas assembléias realizadas durante os dias úteis deverão ocorrer em períodos distintos. 
<br><b>Parágrafo segundo</b> - O SINDICATO DA CATEGORIA PROFISSIONAL deverá informar ao SEMESP ou à MANTENEDORA, por escrito, com antecedência mínima de quinze dias corridos. Na comunicação deverão constar a data e o horário da assembléia. 
...
<br><b>Parágrafo quarto</b> - A MANTENEDORA poderá exigir dos PROFESSORES e do dirigente sindical atestado emitido pelo SINDICATO DA CATEGORIA PROFISSIONAL que comprove o seu comparecimento à assembléia. 
...
<tr><td class=titulo>45. Congresso do Sindicato da Categoria Profissional 
<tr><td class=campo style="text-align:justify">Na vigência desta Convenção, o SINDICATO DA CATEGORIA PROFISSIONAL promoverá um evento de natureza política ou pedagógica (congresso ou jornada). A MANTENEDORA abonará as ausências de seus PROFESSORES que participarem do evento, nos seguintes limites: 
...
Tais faltas, limitadas ao máximo em dois dias úteis além do sábado, em cada evento, serão abonadas mediante a apresentação de atestado de comparecimento fornecido pelo SINDICATO DA CATEGORIA PROFISSIONAL. O PROFESSOR deverá repor as aulas que, por ventura, sejam necessárias para complementação das horas letivas mínimas exigidas pela legislação. 

<tr><td class=titulo>46. Relação nominal 
<tr><td class=campo style="text-align:justify">Na vigência desta Convenção, obriga-se a MANTENEDORA a encaminhar ao SINDICATO DA CATEGORIA PROFISSIONAL, até o final do mês de junho de cada ano, a relação nominal dos PROFESSORES que integram seu quadro de funcionários, acompanhada do valor do salário mensal e das guias das contribuições sindical e assistencial.
...
<br><b>Parágrafo primeiro</b> - O Foro será composto por membros do SEMESP e do SINDICATO DA CATEGORIA PROFISSIONAL. As reuniões deverão contar, também, com as partes em conflito que, se assim o desejarem, poderão delegar representantes para substituí-las e/ou serem assistidas por advogados. 
<br><b>Parágrafo segundo</b> - O SEMESP e o SINDICATO DA CATEGORIA PROFISSIONAL deverão indicar os seus representantes no Foro num prazo de trinta dias a contar da assinatura desta Convenção. 
...
<tr><td class=campo style="text-align:justify">Ficam assegurados os direitos mais favoráveis decorrentes de acordos internos ou de acordos coletivos de trabalho celebrados entre a MANTENEDORA e o SINDICATO DA CATEGORIA PROFISSIONAL. 
...
<b>Parágrafo primeiro</b> – A MANTENEDORA deverá enviar ao SINDICATO DA CATEGORIA PROFISSIONAL cópia do contrato formalizado com a empresa de assistência médico–hospitalar ou de seguro saúde ou de medicina de grupo que comprove o valor pago. 
...
<br><b>Parágrafo único</b> – Encontra-se no SINDICATO DA CATEGORIA PROFISSIONAL, à disposição da MANTENEDORA, cópia de autorização do PROFESSOR para o desconto da mensalidade associativa. 
...
<tr><td class=campo style="text-align:justify">São Paulo, 30 de junho de 2010.
