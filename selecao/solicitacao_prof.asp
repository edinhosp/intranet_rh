...
<title>Solicitação de Emprego - Professor</title>
...
if request("tipo")="C" then
	...
	titulo1="Solicitação de Emprego"
...
<tr>
	...
	<td class=campo style="border-top:1px solid #000000;border-right:1px solid #000000"><b>Tempo de residência no país?</b></td>
	<td colspan=4 class=campo style="border-top:1px solid #000000;border-left:1px solid #000000;border-right:1px solid #000000"><b>É deficiente físico?</b></td>
	<td class=campo style="border-top:1px solid #000000;border-right:1px solid #000000"><b>Que tipo de deficiência?</b></td>
</tr>
<tr>
	<td class=campo style="border-left:1px solid #000000;" valign="center" width=16><img src="../images/bola.gif" width=16 border="0"></td>
	<td class=campo style="" align="left">até ____/200___</td>
	<td class=campo style="" width=16><img src="../images/bola.gif" width=16 border="0"></td>
	...
	<td class=campo style="" width=16><img src="../images/bola.gif" width=16 border="0"></td>
	<td class=campo align="left" style="border-right:1px solid #000000" width=16>Não</td>
	<td class=campo style="border-right:1px solid #000000">&nbsp;</td>
</tr>
</table>
-->
...
<table border="0" cellpadding="<%=espacamento%>" cellspacing="0" width="650" style="border-collapse: collapse">
<tr>
	<td class=campo width=40% rowspan=2 valign=top style="border-top:1px solid #000000;border-left:1px solid #000000;border-right:1px solid #000000"><b>Tem parentes ou conhecidos<br>nesta Instituição de Ensino?</b></td>
...
<table border="0" cellpadding="<%=espacamento%>" cellspacing="0" width="650" style="border-collapse: collapse">
<tr>
	<td class=campo width=41% valign=top style="border-top:1px solid #000000;border-left:1px solid #000000;border-right:1px solid #000000"><b>Escolaridade/Titulação</b></td>
...
<table border="0" cellpadding="<%=espacamento%>" cellspacing="0" width="650" style="border-collapse: collapse">
<tr><td class=campo colspan=4 valign=top style="border-top:1px solid #000000;border-left:1px solid #000000;border-right:1px solid #000000"><b>Cursos Graduação/Especialização/Etc.</b></td>
</tr>
<tr><td class=campo width=20% style="border-left:1px solid #000000;border-bottom:1px solid #000000">Tipo</td>
	...
	<td class=campo width=35% style="border-left:1px solid #000000;border-bottom:1px solid #000000">Instituição</td>
	<td class=campo width=10% style="border-left:1px solid #000000;border-bottom:1px solid #000000;border-right:1px solid #000000">Conclusão</td>
</tr>
...
<table border="0" cellpadding="<%=espacamento%>" cellspacing="0" width="650" style="border-collapse: collapse">
<tr><td class=campo colspan=5 valign=top style="border-top:1px solid #000000;border-left:1px solid #000000;border-right:1px solid #000000"><b>Veículos que utiliza (para emissão do crachá de estacionamento)</b></td>
</tr>
...
<table border="0" cellpadding="<%=espacamento%>" cellspacing="0" width="650" style="border-collapse: collapse">
<tr><td class=campo colspan=2 valign=top style="border-top:1px solid #000000;border-left:1px solid #000000;border-right:1px solid #000000"><b>Nome reduzido para crachá de identificação (até 9 caracteres)</b></td>
</tr>
