...
if request.form("B1")="" then
	...
	"c.NOME as funcao, f.CODHORARIO, h.DESCRICAO as horario, f.SALARIO " & _
...
if request.form("chapa")<>"" then
	...
	salario=rs2("salario")
	rs2.close
if request("titulo")<>"" then titulo=request("titulo") else titulo=""
end if
...
%>
<form name="form" action="transferencia.asp" method="post">
<table border="1" bordercorlor="#CCCCCC" cellpadding="4" cellspacing="0" style="border-collapse: collapse">
<tr>
	<td class=titulo colspan=3>Transferência de funcionário</td>
</tr>
<tr>
...
<tr>
	...
	<option value="0">Selecione a seção para transferência</option>
<%
...
<tr>
	...
	<option value="0">Selecione a função de transferência</option>
<%
...
<tr>
	...
	<option value="0">Selecione o horário de transferência</option>
<%
...
<tr>
	...
	<td class=campo colspan=2><%=formatnumber(salario,2)%><input type="hidden" name="salario0" size="10" value="<%=salario%>"></td>
</tr>
<tr>
	<td class=campo>Salário na transferência</td>
...
<table border="0" cellpadding="5" cellspacing="0" width="650">
	...
	<td class="campop" style="border-right:1px solid #000000">
	<input type="text" value="<%=tsalario%> (<%=perc%>)" name="salario_novo" size=50 class=form_input10 style="border-bottom:0px solid #000000">
	</td></tr>
</table>
