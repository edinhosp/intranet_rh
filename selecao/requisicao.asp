...
"rq.dt_abertura, rq.dt_encerramento, year(dt_abertura) " & _
"FROM rs_requisicao rq " & _
"WHERE rq.id_requisicao>0 and (rq.dt_abertura>='20130101' or rq.dt_encerramento>='20130101') "
sqlb=""
sqlc="ORDER BY year(dt_abertura) desc, rq.descricao, rq.dt_abertura "
...
<p class=titulo style="margin-top: 0; margin-bottom: 0">Requisição de Pessoal</p>
...
<tr>
    ...
    <td class=titulo align="center">Form.       </td>
    <td class=titulor align="center">Alterar    </td>
</tr>
<%
linha=1
'rs.movefirst
