...
if request.form("bt_salvar")<>"" then
	...
	if request.form("idgrupo")="" then tudook=0:response.write "<script language='JavaScript' type='text/javascript'>alert('Código: Informe o código do grupo!');</script>"
	...
	sql = "INSERT INTO intranet_grupos (idgrupo, descricao, sigla) "

	sql2 = " SELECT " & request.form("idgrupo") & " "
...
%>
<form method="POST" action="grupos_nova.asp" name="form">
<table border="0" cellpadding="3" cellspacing="0" style="border-collapse: collapse" width="500">
<tr><td class=grupo>Inclusão de Grupo</td></tr>
</table>
...
<tr>
	<td class=fundo><input type="text" name="idgrupo" size="5" value="<%=request.form("idgrupo")%>"></td>
	<td class=fundo><input type="text" name="descricao" size="35" value="<%=request.form("descricao")%>"></td>
