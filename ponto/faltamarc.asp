...
<form method="POST" action="faltamarc.asp">
  ...
  <input type="checkbox" name="formulario" value="ON">Imprimir verso com Formulário de Justificativa<br>
  <input type="checkbox" name="mesmapagina" value="ON">Imprimir Formulário de Justificativa na mesma página<br>
...
<tr>
	<td class="campop" valign=top><p style="margin-top:0;margin-bottom:0;text-align:justify">
	<b>A Instrução nº 19/2005-Reitoria de 09/11/2005 (alterada pela Portaria nº 308 de 10/11/2010), no seu item 5, regulamenta penalidades e limita o número de esquecimentos
	 a 2 por mês. Até o momento, nossos registros totalizam <%=esquecimento%>.
	</td>
</tr>
<tr>
	<td class="campop" valign=top>
...
<%next%>
	<tr>
		<td valign="top" colspan="12"><font size="1">Cód. Justificativas:<br>
		...
		<b>EL</b> - Erro Leitura |
		<b>RD</b> - Relógio desligado, atrasado etc 
		</font></td>
	</tr></table>
