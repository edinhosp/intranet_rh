...
-->
<table width="200" height="320" border=0 cellspacing=0 cellpadding=0 style='border-collapse: collapse' bordercolor="#dcdcdc">
<tr><td width=0>&nbsp;</td><td valign="top" align="center">
<!-- page -->
...
<tr><td valign="top" align="center">
<p style="font-size:11px"><b>Registro FIEO: <%=rs2("chapa")%> - <%=digito(rs2("chapa"))%></b></p>
</td></tr>
