...
if session("a2")="N" or session("a2")="" then response.write "<script language='JavaScript' type='text/javascript'>window.top.location.href='" & Application("Site") & "';</script>"
%>
<html>
<head>
...
if request.form<>"" then
	...
	"where f.codpessoa=p.codigo and f.codsecao=s.codigo and (f.chapa<'10000' or f.chapa>='90000') and f.codsituacao<>'D' " & _
