...
pagina=0
sql1="select c.nome, c.prontuario, c.via, c.dtnasc, c.cursos, e.idimagem " & _
"from crachaa c, corporerm.dbo.ealunos e " & _
"where e.matricula=c.prontuario " & _
"order by c.nome "
rs2.Open sql1, ,adOpenStatic, adLockReadOnly
total=int(rs2.recordcount/4)
resto=rs2.recordcount-(total*4)
for a=1 to total
ponteiro=a*4-3
ponteirof=a*4
for b=1 to 4
...
<tr><td valign="top" align="left"><img src="../images/logo_centro_universitario_unifieo_big.jpg" height="40" border="0" alt="">
	<br><br>
	<font style="font-color:Gray;font-size:12pt">PROVISÓRIO</font>
	<br>
	<font style="font-color:Black;font-size:10pt">Válido até 31/03/2009</font>

	</td>
	<td valign="center" align="center"><img border="0" src="../aluno_foto.asp?id=<%=rs2("idimagem")%>" height="90"></td>
</tr>
<tr><td valign="top" align="center" colspan=2 class=fundo height=50>
	<table cellspacing=0 border=0 width=315>
		<tr><td class=fundo align="left" valign="center" colspan=2>
		...
		<tr><td class=fundo align="left" valign="center">
			...
			<p style="font-size:10px;margin-top:0;margin-bottom:0"><b><%=rs2("prontuario")%></b></p>
		</td><td class=fundo align="left" valign="center">
			<p style="font-size:8px;margin-top:0;margin-bottom:0"><b>Via</b></p>
			<p style="font-size:10px;margin-top:0;margin-bottom:0"><b><%=rs2("via")%></b></p>
		</td></tr>
	</table>
</td></tr>
</table>
...
<br>
<%
rs2.move b, ponteiro 'adBookmarkFirst
next 'b
pagina=pagina+1
response.write "<br><p style='margin-top:0;margin-bottom:0;text-align:center'>" & pagina & "</p>"
%>
<DIV style="page-break-after:always"></DIV>
<%
rs2.move -3,ponteirof
for b=1 to 4
%>
<div align="center">
<!-- *********************** -->
...
<tr><td valign="center" align="left">
	...
	<p style="font-size:10px;margin-top:0;margin-bottom:0"><b>&nbsp;&nbsp;<%=rs2("cursos")%></b></p>
...
<%
Response.Write getCodigoBarras(rs2("prontuario")&rs2("via")) & "<br>"
%>
<br>
</td></tr>
</table>
