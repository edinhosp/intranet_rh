...
<form method="POST" action="crachafunc.asp" name="form">
...
%>
<div align="center">
<table width="400" height="320" border=1 cellspacing=0 cellpadding=0 style='border-collapse: collapse' bordercolor="#dcdcdc">
