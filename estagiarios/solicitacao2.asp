...
<p class=realce>Emissão de Solitação de Estágio - com foto e dados</p>
...
<table border="0" cellpadding="5" cellspacing="0" width="650" style="border-collapse: collapse">
	...
	<tr>
		<td align="center" colspan=2><p style="font-family:'Century Gothic';font-size:16pt;margin-top:0;margin-bottom:0"><b>Proposta de prestação de serviços</b></td>
	</tr>
</table>
<br>
...
<tr>
	...
	<td class="campop" valign=top colspan=2><b>Horários disponíveis:</td>
	
</tr>
<tr>
	<td class=campo width=15><img src="../images/bola.gif" width=16 border="0"></td>	
	<td class=campo><b>Atendimento / Digitação</td>
	<td class=campo width=15>&nbsp;</td>	
	<td class=campo width=15><img src="../images/bola.gif" width=16 border="0"></td>	
	<td class=campo>10h às 16h</td>	
</tr>
<tr>
	<td class=campo width=15><img src="../images/bola.gif" width=16 border="0"></td>	
...
<table border="0" cellpadding="5" cellspacing="0" width="650" style="border-collapse: collapse">
	<tr><td class=campo valign=top style="border-top:1px solid #000000;border-left:1px solid #000000;border-right:1px solid #000000">
	<b>Qual curso você estuda?:</b></td></tr>
	<tr><td class="campop" style="border-left:1px solid #000000;border-right:1px solid #000000">
	&nbsp;</td></tr>
</table>
