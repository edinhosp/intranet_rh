...
%>
<p class=titulo>Seleção para impressão geral de crachás de visitantes</p>
<form method="POST" action="cracha_visitante.asp" name="form">
...
<tr><td class=titulo>A partir do nº <input type="text" name="numero" value="1" size=3>
	Quantidade <input type="text" name="quantidade" value="10" size=3>
	</td></tr>
<tr><td class=titulo>Validade <input type="text" name="validade" value="<%=validade%>" size=10>
<tr>
...
<tr><td width=537 height=318 valign=top align="left" style="background-color:transparent;border:1px dotted #000000;background:transparent url('../images/<%=imagem%>') no-repeat center;">
	...
	<tr><td height=100% valign=middle align="center" colspan=2 style="background-color:transparent">
			<p style="margin-top:0;margin-bottom:0;color:Black;font-size:36pt;text-align:center"><b><%="VISITANTE"%></td>
	</tr>
...
<!-- quadro com o texto -->
	...
	Para uso exclusivo de visitantes
	</td></tr>
	</table>
</td></tr>
</table>
