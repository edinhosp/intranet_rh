...
<form method="POST" action="cracha_aluno.asp" name="form">
...
if finaliza=1 then
	...
	if idchapa="Narciso" then
		sqld=" and campus='Narciso' ":texto1="<b>Narciso</b>":imagem="1sem_n.GIF":imagemv="1sem_n_v.gif"
	elseif idchapa="Yara" then
		sqld=" and campus='V. Yara' ":texto1="<b>V. Yara</b>":imagem="1sem_y.GIF":imagemv="1sem_y_v.gif"
	else
		sqld=""
	end if

	sql1="select matricula, nome, curso, validade, campus, placa from veiculos_alunos " & _
...
<tr><td width=<%=t1w%> height=<%=t1h%> valign=top align="left" style="background-color:transparent;border:1px dotted #000000;background:transparent url('../images/<%=imagem%>') no-repeat center;">
	...
	<tr><td height=100% valign=middle align="center" colspan=2 style="background-color:transparent">
			<p style="margin-top:0;margin-bottom:0;color:Black;font-size:36pt;text-align:center"><b><%=rs("placa")%>
		</td>
	</tr>
...
<!-- quadro com o texto -->
	...
	<%=rs.absoluteposition%>&nbsp;&nbsp;Nome: <%=rs("nome")%> &nbsp;&nbsp;Curso: <%=rs("curso")%>
	</td></tr>
	</table>
...
<div align="center">
&nbsp;&nbsp;Nome: <%=rs("nome")%><br>
&nbsp;&nbsp;Curso: <%=rs("curso")%><br><%=rs.absoluteposition%><br>
...
<tr><td valign="center" align="center" style="border:1px dotted #000000;border-bottom:1px dotted #000000"><img src="../images/fundo_cracha3.bmp" border="0">
</td></tr>
</table>
</div>
<%
