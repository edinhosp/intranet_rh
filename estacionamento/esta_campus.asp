...
<p class=titulo style="margin-top: 0; margin-bottom: 0">Controle de Estacionamento para funcionários estudando</p>
...
<tr>
	...
	<td class=titulor align="center" rowspan=2>Funcionário</td>
	<td class=titulor align="center" rowspan=2>Matricula</td>
	<td class=titulor align="center" colspan=2>Campus</td>
	<td class=titulor align="center" rowspan=2>Período</td>
	<td class=titulor align="center" colspan=3>Veículo</td>
...
%>
<td class=grupo colspan=12>Esta seleção não mostra nenhum registro.</td>
<%
end if
%>
</table>
...
<option value="Todas" <%if session("sel87")="Todas" then response.write "selected"%>>Todos serviços</option>
<%
