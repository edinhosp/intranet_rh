...
d11="N" 'não é declaração de extinção
d12="" 'space(8)

linha = d01 & chr(124) & d02 & chr(124) & d03 & chr(124) & d04 & chr(124) & d05 & chr(124) & d06 & chr(124) & d07 & chr(124) & d08 & chr(124) & d09 & chr(124) & d10 & chr(124) & d11 & chr(124) & d12 & chr(124)
string_sql = "INSERT INTO autonomo_dirf (competencia, linha, linhadirf) " & _
"SELECT '" & anobase & "', " & sequencia & ", '" & linha & "'"
conexao.execute string_sql
...
do while not rsc.eof
	...
	r01=numzero(nrfile(formatnumber(rs("r01"),2)),15): c01=numzero(nrfile(formatnumber(rs("d01"),2)),15): e01=numzero(nrfile(formatnumber(rs("i01"),2)),15)
	r02=numzero(nrfile(formatnumber(rs("r02"),2)),15): c02=numzero(nrfile(formatnumber(rs("d02"),2)),15): e02=numzero(nrfile(formatnumber(rs("i02"),2)),15)
	r03=numzero(nrfile(formatnumber(rs("r03"),2)),15): c03=numzero(nrfile(formatnumber(rs("d03"),2)),15): e03=numzero(nrfile(formatnumber(rs("i03"),2)),15)
	r04=numzero(nrfile(formatnumber(rs("r04"),2)),15): c04=numzero(nrfile(formatnumber(rs("d04"),2)),15): e04=numzero(nrfile(formatnumber(rs("i04"),2)),15)
	r05=numzero(nrfile(formatnumber(rs("r05"),2)),15): c05=numzero(nrfile(formatnumber(rs("d05"),2)),15): e05=numzero(nrfile(formatnumber(rs("i05"),2)),15)
	r06=numzero(nrfile(formatnumber(rs("r06"),2)),15): c06=numzero(nrfile(formatnumber(rs("d06"),2)),15): e06=numzero(nrfile(formatnumber(rs("i06"),2)),15)
	r07=numzero(nrfile(formatnumber(rs("r07"),2)),15): c07=numzero(nrfile(formatnumber(rs("d07"),2)),15): e07=numzero(nrfile(formatnumber(rs("i07"),2)),15)
	r08=numzero(nrfile(formatnumber(rs("r08"),2)),15): c08=numzero(nrfile(formatnumber(rs("d08"),2)),15): e08=numzero(nrfile(formatnumber(rs("i08"),2)),15)
	r09=numzero(nrfile(formatnumber(rs("r09"),2)),15): c09=numzero(nrfile(formatnumber(rs("d09"),2)),15): e09=numzero(nrfile(formatnumber(rs("i09"),2)),15)
	r10=numzero(nrfile(formatnumber(rs("r10"),2)),15): c10=numzero(nrfile(formatnumber(rs("d10"),2)),15): e10=numzero(nrfile(formatnumber(rs("i10"),2)),15)
	r11=numzero(nrfile(formatnumber(rs("r11"),2)),15): c11=numzero(nrfile(formatnumber(rs("d11"),2)),15): e11=numzero(nrfile(formatnumber(rs("i11"),2)),15)
	r12=numzero(nrfile(formatnumber(rs("r12"),2)),15): c12=numzero(nrfile(formatnumber(rs("d12"),2)),15): e12=numzero(nrfile(formatnumber(rs("i12"),2)),15)
	rs.close	
	v13=numzero(0,15)
	sequencia=sequencia+1
	d01="RTRT"
