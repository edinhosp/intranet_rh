...
<body>
<%
dim conexao, chapach, rs, rs2, t(4)
...
sqli="select top 4 perlet3 from g2ch group by perlet3 order by perlet3 desc"
a=1
...
"FROM (grades_3ch g INNER JOIN totalizador_3ch t ON g.chapa1 = t.chapa1) INNER JOIN dc_professor d ON g.chapa1 = d.CHAPA collate database_default " & _
